	  ...
	  bool tmpRet = false;
			  if(PhotonNetwork.room.PlayerCount > 1) {
			   tmpRet = true;
				...
				PanelMinPlayerToStartGameHand.transform.Find("Text").GetComponent<Text>().text = "At Least 2 Players To Start Game Hand...";
			  }
      return tmpRet;
	}
...
#region cards management
  ...
  void activateStartGameButton() {
		_BBGuiInterface.TextGamePhase.text = "Phase : " + "Wainting hand"; 
		if(PhotonNetwork.player.IsMasterClient) {
				_RPCController.shareInfomessagePlayerRelated(""," Waiting Dealer Start Game Hand...",0,true);
                ButtonStartTheGame.SetActive(true);
       }
