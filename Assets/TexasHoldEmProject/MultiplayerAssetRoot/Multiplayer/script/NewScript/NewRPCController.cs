...
*/
	 ...
	 public IEnumerator ShareMoneyData() {
		...
		for(int x = 0; x < tmpList.Count;x++) {
			...
			_BBGuiInterface.TextGamePOT.text = "Hand Pot : " + BBStaticData.getMoneyValue( _GameController.getFloatRoomProperties(NewGameControllerMultiplayer.CustomPropertiesKeyList.moneyOnTable/*"moneyOnTable"*/));
